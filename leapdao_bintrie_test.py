import leapdao_new_bintrie as t1
import leapdao_new_bintrie_optimized as t2
import leapdao_new_bintrie_hex as t3
import time
import binascii

keys = [t1.keccak(bytes([i // 160, i % 160]))[12:] for i in range(10000)]
